...
cars = pd.read_csv("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360DigiTmg Assignment/Probability Distribution, CLT, Confidence Interval/Cars.csv")

#a. P(MPG>38)
cars.columns
Total = cars.MPG.count()
...
# using sum()
# to get numbers > k
count1 = sum(i > k for i in MPG)

Probability1 = (count1 / Total)*100 # 40.74%
Probability1
...
# using sum()
# to get numbers > k
count2 = sum(i < l for i in MPG)

Probability2 = (count2 / Total)*100 # 75.30%
Probability2
...
wc = pd.read_csv("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360DigiTmg Assignment/Probability Distribution, CLT, Confidence Interval/wc-at.csv")
...
stats.norm.ppf(0.95,0,1) # 1.645
"Z scores of 94% confidence interval"
stats.norm.ppf(0.97,0,1) # 1.88
"Z scores of 60% confidence interval"
stats.norm.ppf(0.80,0,1) # 0.841
